...
def package_model(model_name):
    ...
    packaged_models_dir = "packaged_models"
    package_dir = "package"
    output_dir = os.path.join(packaged_models_dir, package_dir)

    # Create output directory if it doesn't exist
    if not os.path.exists(packaged_models_dir):
        os.makedirs(packaged_models_dir)
